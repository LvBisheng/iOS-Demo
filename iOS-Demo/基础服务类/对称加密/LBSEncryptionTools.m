...
@interface LBSEncryptionTools()
    @property (nonatomic, assign) int keySize;
    @property (nonatomic, assign) int blockSize;
    @end

@implementation LBSEncryptionTools
    
+ (instancetype)sharedLBSEncryptionTools {
    static LBSEncryptionTools *instance;
